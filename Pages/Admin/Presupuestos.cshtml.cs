...
namespace PagesObrasApp.Pages.Admin
{
    ...
    public class PresupuestosModel : PageModel
    {
        ...
        public PresupuestosModel(IPresupuestoHttpService presupuestoHttpService, IObraHttpService obraHttpService)
        {
        ...
        public async Task<IActionResult> OnPostCambiarEstadoAsync(int id, string accion)
        {
            ...
            var cambiado = await _presupuestoHttpService.CambiarEstadoAsync(id, nuevoEstado);
